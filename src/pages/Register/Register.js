...
<input className='btn btn-active btn-accent text-white w-full my-2 text-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-accent-focus duration-300' value='Register' type="submit" />
    </form>
