...
{/* Password input field here  */}
  ...
  <label className="label">
    <span className="label-text">Forget Password?</span>
      ...
      <input className='btn btn-active text-white btn-accent text-xl w-full my-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-secondary-700-focus duration-300' value='Log in' type="submit" />
    </form>
    ...
    <button className="btn btn-outline  w-full hover:text-slate-50">Continue with Google</button>
    <button className="btn btn-outline w-full mt-3 hover:text-white">Continue with Facebook</button>
      </div>
    </div>
  </div>
</div>
