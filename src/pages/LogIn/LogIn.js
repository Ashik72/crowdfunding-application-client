...
{/* Password input field here  */}
  ...
  <label className="label">
    <span className="label-text">Forget Password?</span>
      ...
      <input className='btn btn-active btn-accent text-xl text-white w-full my-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-secondary-700-focus duration-300' value='Log in' type="submit" />
    </form>
    ...
    <button onClick={googleSignIn} className="btn btn-outline  w-full hover:text-slate-50">Continue with Google</button>
