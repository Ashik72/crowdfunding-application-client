    ...
    signInPopUp(googleProvider)
      .then(result => {
        ...
        fetch('http://localhost:5000/users')
          .then(res => res.json())
          .then(data => {
            const postUserData = data.find(post => post.email === googleUser.email);
        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            <div className='w-96 p-7'>
              ...
              <p className='text-sm'>New to AidHumans? <Link className='text-primary' to='/register'>Create an new account</Link></p>
