...
const DashboardUser = () => {
  return (
    <div className='bg-gray-200 w-full p-6'>
      <p className='mb-3 lg:block hidden text-gray-700 font-bold text-3xl text-center font-serif'>Hi, Murad Wahid Welcome to Our Dashboard</p>
      <p className='mb-3 lg:hidden block text-gray-700 font-bold text-3xl text-center font-serif'>Hi, Murad Wahid</p>
      <div className="mt-6">
        ...
        <div className='flex gap-7 mt-6 flex-col'>
          <div className='mx-auto'>
            <img src={murad} className="h-36 w-36 object-cover rounded-md" alt="" />
          </div>
          <div className='text-center'>
            <p className='text-xl text-gray-800 font-semibold font-serif'>Name: Murad Wahid</p>
            <p className='text-gray-800 font-serif my-2'><span className='font-semibold'>Address: </span> </p>
