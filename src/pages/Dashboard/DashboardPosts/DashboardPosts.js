...
const DashboardPosts = () => {
  ...
  return (
    <div className="pt-32 w-full overflow-y-scroll bg-[#F1F5F9] pb-24 font-serif">
      <div className="lg:w-3/4 mx-auto p-7 bg-[#ffffff13] rounded-lg dashboard-post-shadow">
        <h3 className="text-3xl text-slate-800 font-semibold font-serif">
          Add Blog
        </h3>
        ...
        <form onSubmit={handleSubmit(handelAddBlog)}>
          <div className="flex gap-6">
            ...
            <div className="form-control w-full">
              <label className="label">
                <span className="label-text text-slate-800">Title</span>
              </label>
              <input
                type="text"
            ...
            <div className="form-control w-full">
              <label className="label">
                <span className="label-text text-slate-800">Author Name</span>
              </label>
              <input
                type="text"
          ...
          <div className="flex gap-6">
            ...
            <div className="form-control w-full">
              <label className="label">
                <span className="label-text text-slate-800">Image</span>
              </label>
              <input
                type="file"
            ...
            <div className="form-control w-full">
              ...
              />
              {errors.authorImg && (
                <p className="text-red-600">{errors.authorImg?.message}</p>
              )}
            </div>
          </div>
          {/* Date */}
          {/* <div className="form-control w-full">
            <label className="label"><span className="label-text text-slate-800">Date</span></label>
            <input type="text"
              {...register("date",
          ...
          <div className="form-control w-full">
            <label className="label">
              <span className="label-text text-slate-800">Our Works Title</span>
            </label>
            <input
              type="text"
              ...
              className="input input-bordered w-full bg-gray-300"
            />
            {errors.ourWorksTitle && (
              <p className="text-red-600">{errors.ourWorksTitle?.message}</p>
            )}
          </div>
          {/* ourWorks */}
          <div className="form-control w-full">
            <label className="label">
              <span className="label-text text-slate-800">Our Works</span>
            </label>
            <input
              type="text"
              {...register("ourWorks", { required: "Our Works is required" })}
              className="input input-bordered w-full bg-gray-300"
            />
            {errors.ourWorks && (
              <p className="text-red-600">{errors.ourWorks?.message}</p>
            )}
          </div>
