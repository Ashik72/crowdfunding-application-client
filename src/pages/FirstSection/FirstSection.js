...
const FirstSection = () => {
  ...
  return (
    <div className=" hidden lg:block">
      <div
        className="grid mt-[600px] items-center gap-5 p-10 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 w-[90%] bg-[#3cf09c]  mx-auto mb-[150px] custom"
        style={{
      ...
      >
        <div className="indicator">
          <span className="indicator-item cursor-pointer left-[110px] right-0 h-[30%] w-[10%] rounded-full indicator-middle badge bg-white hover:bg-[#202124] hover:text-[white] hover:border-none text-black video-icons-animations">
            {video}
          </span>
